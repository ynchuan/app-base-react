...
/***/ function(module, exports, __webpack_require__) {
	...
	React.render(React.createElement(Search, null), searchDom);
...
/***/ function(module, exports, __webpack_require__) {
		...
		render: function render() {
			...
			retDom = titleList.map((function (ele, i) {
				...
				return React.createElement(
					"a",
					{ href: "#", className: clstmp },
					ele
				);
			}).bind(this));
			return React.createElement(
				"div",
				{ className: "search-title", onClick: this.linkClick },
				retDom
			);
		},
	...
	var SearchBody = React.createClass({
		displayName: "SearchBody",

		render: function render() {
			return React.createElement(
				"div",
				{ className: "search-body" },
				React.createElement("input", { type: "text", className: "inpt-search", ref: "searchinput" }),
				React.createElement(
					"button",
					{ className: "search-btn", onClick: this.search },
					" 搜索 "
				)
			);
		},
	...
	var Search = React.createClass({
		...
		render: function render() {
			return React.createElement(
				"div",
				null,
				React.createElement(SearchLinks, { renderVal: this.state.renderVal, linkClick: this.linkClick }),
				React.createElement(SearchBody, { selectVal: this.state.renderVal })
			);
		}
	});
