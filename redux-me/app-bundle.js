...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputStore = __webpack_require__(176);
	...
	var store = (0, _inputStore2.default)(); //创建store，包含reduce
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputReducer = __webpack_require__(184);
	...
	var rootReducer = (0, _Redux.combineReducers)(_inputReducer2.default);
	var tmp = function (rootReducer) {
	    return function () {
	        return (0, _Redux.createStore)(rootReducer);
	    };
	}(_inputReducer2.default);
	exports.default = tmp;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _inputAction = __webpack_require__(186);

	var actions = _interopRequireWildcard(_inputAction);
	...
	//注意：绑定的action为object reduce为function
	    ...
	    _createClass(Input, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("input", { type: "text", onChange: this.handlerChange.bind(this), value: this.props.dftValue,
	                    ref: "iptChg" }),
	                this.props.dftValue
	            );
	        }
	        ...
	        value: function handlerChange() {
	            var val = this.refs.iptChg.value.trim();
